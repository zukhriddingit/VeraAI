      ...
      <article className={styles.article}>
        ...
        <section>
          ...
          <p>
            ...
            export and deletion will be announced only after their production lifecycle has been
            verified. You can revoke Google access in your Google Account and unshare or unpair the
            browser connector at any time.
          </p>
        </section>
      </article>
    </main>

    ...
    <main className={styles.page}>
      ...
      <article className={styles.article}>
        ...
        <p className={styles.lede}>
          ...
          access requests, or deletion requests can be sent to{" "}
        ...
        <section>
          ...
          <p>
            ...
            Imported listing facts, source links, provenance, and audit-safe activity metadata may
            be retained in your Vera account.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            for or type credentials and stops for login, 2FA, CAPTCHA, consent, checkpoints,
            blocking, and changed layouts.
          </p>
        </section>
        <section>
          ...
          <p>
            ...
            transfer it for an unrelated purpose. A human may inspect a minimized support record
            only with your specific support consent, when necessary for security, when required by
            law, or in aggregated or anonymized operations.
          </p>
